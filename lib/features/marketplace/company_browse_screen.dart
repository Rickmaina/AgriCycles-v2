...
class CompanyBrowseScreen extends ConsumerStatefulWidget {
  const CompanyBrowseScreen({super.key});

  @override
  ConsumerState<CompanyBrowseScreen> createState() =>
      _CompanyBrowseScreenState();
}

class _CompanyBrowseScreenState extends ConsumerState<CompanyBrowseScreen> {
