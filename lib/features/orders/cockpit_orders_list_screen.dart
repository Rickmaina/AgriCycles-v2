...
import 'cockpit_order_detail_screen.dart';

class CockpitOrdersListScreen extends ConsumerStatefulWidget {
  const CockpitOrdersListScreen({super.key});

  @override
  ConsumerState<CockpitOrdersListScreen> createState() =>
      _CockpitOrdersListScreenState();
}

class _CockpitOrdersListScreenState
    extends ConsumerState<CockpitOrdersListScreen> {
  int _tab = 0;
    ...
    return Material(
      ...
      child: InkWell(
        ...
        onTap: () => Navigator.of(context).push(
          MaterialPageRoute(
            builder: (_) => CockpitOrderDetailScreen(orderId: order.id),
          ),
        ),
        child: Container(
